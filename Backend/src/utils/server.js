...
const handleWebSocket = require('../utils/wsHandler');
const { notifyDrivers, notifyRiders } = require('../utils/notify');
const pool = require('../../db'); // adjust path as needed


// const http = require('http');
const WebSocket = require('ws');  // import WebSocket library
const { setWss } = require('../utils/notify'); // adjust path as needed
